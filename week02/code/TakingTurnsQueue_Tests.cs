...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: It does not properly re-enqueu people that have turns still remaining.
    ...
    // Defect(s) Found: George does not get re-queued.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The infinite turns are not working
    ...
    // Defect(s) Found:  Infinite turns are not handled right.
    ...
    // Defect(s) Found: The exception message was not correct.
